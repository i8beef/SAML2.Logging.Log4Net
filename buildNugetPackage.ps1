param(
	[string]$project = ".\src\SAML2.Logging.Log4Net\SAML2.Logging.Log4Net.csproj",
	[string]$solution = ".\src\SAML2.Logging.Log4Net.sln",
	[string]$assemblyInfoFile = ".\src\SAML2.Logging.Log4Net\Properties\AssemblyInfo.cs",
	[string]$nuspecFile = ".\src\SAML2.Logging.Log4Net\SAML2.Logging.Log4Net.nuspec"
)
